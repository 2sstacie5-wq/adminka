(function () {
  ...
  function buildApp() {
    ...
    app.innerHTML = `
      ...
      <p class="subtitle">Клікай на день, щоб призначити чергування. Внизу кожного місяця — кількість робочих днів і сума виплати (900 грн/день) для кожної. Графік спільний — зміни бачать усі, хто відкрив цю сторінку.</p>
